...
class FilterWidgetForLateSubscribers extends StatefulWidget {
  const FilterWidgetForLateSubscribers({super.key, required this.visible, required this.companiesList});
  final bool visible;
  final List<String> companiesList;

  @override
  State<FilterWidgetForLateSubscribers> createState() => _FilterWidgetForLateSubscribersState();
}

class _FilterWidgetForLateSubscribersState extends State<FilterWidgetForLateSubscribers> {

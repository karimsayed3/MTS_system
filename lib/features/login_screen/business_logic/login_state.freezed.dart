...
/// @nodoc
abstract class _$$ObscureTextStateImplCopyWith<T, $Res> {
  factory _$$ObscureTextStateImplCopyWith(_$ObscureTextStateImpl<T> value,
          $Res Function(_$ObscureTextStateImpl<T>) then) =
      __$$ObscureTextStateImplCopyWithImpl<T, $Res>;
}

/// @nodoc
class __$$ObscureTextStateImplCopyWithImpl<T, $Res>
    extends _$LoginStateCopyWithImpl<T, $Res, _$ObscureTextStateImpl<T>>
    implements _$$ObscureTextStateImplCopyWith<T, $Res> {
  __$$ObscureTextStateImplCopyWithImpl(_$ObscureTextStateImpl<T> _value,
      $Res Function(_$ObscureTextStateImpl<T>) _then)
      : super(_value, _then);
}

/// @nodoc

class _$ObscureTextStateImpl<T> implements ObscureTextState<T> {
  const _$ObscureTextStateImpl();

  @override
  String toString() {
    return 'LoginState<$T>.obscureTextState()';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ObscureTextStateImpl<T>);
  }
...
abstract class ObscureTextState<T> implements LoginState<T> {
  const factory ObscureTextState() = _$ObscureTextStateImpl<T>;
}

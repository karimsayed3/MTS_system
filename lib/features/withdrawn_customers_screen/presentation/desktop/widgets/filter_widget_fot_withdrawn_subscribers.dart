...
class FilterWidgetForWithdrawnSubscribers extends StatefulWidget {
  const FilterWidgetForWithdrawnSubscribers({super.key, required this.visible, required this.companiesList});
  final bool visible;
  final List<String> companiesList;

  @override
  State<FilterWidgetForWithdrawnSubscribers> createState() => _FilterWidgetForWithdrawnSubscribersState();
}

class _FilterWidgetForWithdrawnSubscribersState extends State<FilterWidgetForWithdrawnSubscribers> {

...
createExcelForWithdrawnSubscribers({required List<WithdrawnSubscriberData> data})async {
  final excel = Excel.Excel.createExcel();
  var sheet = excel['Sheet1'];
  sheet.isRTL = true;
  sheet.merge(
      Excel.CellIndex.indexByString('A1'), Excel.CellIndex.indexByString('K1'),
      customValue: Excel.TextCellValue('كشف بأسماء المشتركين المسحوبين'));
  ...
  cell.value = Excel.TextCellValue('كشف بأسماء المشتركين المسحوبين');
  ...
  header9.value = const Excel.TextCellValue("تاريخ السحب");

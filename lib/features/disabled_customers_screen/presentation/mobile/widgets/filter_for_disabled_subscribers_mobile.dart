...
class FilterWidgetForDisabledSubscribersMobile extends StatefulWidget {
  const FilterWidgetForDisabledSubscribersMobile(
      {super.key, required this.companiesList});

  final List<String> companiesList;

  @override
  State<FilterWidgetForDisabledSubscribersMobile> createState() =>
      _FilterWidgetForDisabledSubscribersMobileState();
}

class _FilterWidgetForDisabledSubscribersMobileState
    extends State<FilterWidgetForDisabledSubscribersMobile> {
